...
builder.Services.AddSingleton<IPgsqlFactory>(new PgsqlFactory());
builder.Services.AddSingleton<StateStoreInitHelper>();

var app = builder.Build();

// Configure the HTTP request pipeline.
app.MapGrpcService<StateStoreService>();
app.MapGrpcService<TransactionalStateStoreService>();
